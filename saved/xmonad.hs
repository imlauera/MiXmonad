...
myStartupHook = do
  ...
  spawn "feh --bg-fil /home/nist778/wallpaper/beach2.jpg &"
...
myLayoutHook = tall3 ||| tall5 ||| add_layout Full ||| simplestFloat
  where -- tall2 = reflectHoriz $ TwoPane (3/100) (1/2);
        tall3 = add_layout $ reflectHoriz $ ResizableTall 1 (3/100) (1/2) [];
        tall5 = add_layout $ reflectHoriz $ ThreeCol 1 (3/100) (1/2)
...
myDzenStyle  = " -h '20' -bg '#191919' -fn 'ubuntu:regular:size=11'"

myDzenPP  = dzenPP
    { ppCurrent = dzenColor "#B2B2FF" "" . wrap "<" ">"  
